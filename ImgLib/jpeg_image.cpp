        ...
        */
        ...
        while (cinfo.next_scanline < cinfo.image_height) {
            ...
            for (int w = 0; w < image.GetWidth(); ++w) {
                image_buffer.push_back(static_cast<JSAMPLE>(line[w].r));
                image_buffer.push_back(static_cast<JSAMPLE>(line[w].g));
                image_buffer.push_back(static_cast<JSAMPLE>(line[w].b));
            }
